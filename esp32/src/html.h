...
static const char SETUP_AFTER_NETS[] =
    ...
    "</form>"
    "<p class='note'>Device will reboot and broadcast <strong>WifiTree</strong>.</p>"
    "</body></html>";
...
static const char SAVING_HTML[] =
    ...
    "<p>Wifi Tree is restarting. Reconnect to <strong>WifiTree</strong> in a few seconds.</p>"
    "</body></html>";
